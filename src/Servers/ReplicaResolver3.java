...
public class ReplicaResolver3 implements Runnable{
	...
	public ReplicaResolver3(String name, Reliable udp, CenterServer caCenter, CenterServer usCenter, CenterServer ukCenter) {
		super();
		this.name =name;
		this.udp = udp;
