...
public class ReplicaResolver2 implements Runnable{
	...
	public ReplicaResolver2(String name, Reliable udp, CenterServer caCenter, CenterServer usCenter, CenterServer ukCenter) {
		super();
		this.name =name;
		this.udp = udp;
	...
	public void UDPServer() {
		try {
			while(true) {
				System.out.println("Center Server Resolver Listening");
